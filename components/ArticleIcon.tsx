...
const ArticleIcon = ({ isDark, focused, size = 24 }: ArticlesIconProps) => {
const gradientColors = focused
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Defs>
        <LinearGradient id="articlesGradient" x1="0" y1="0" x2="1" y2="0">
